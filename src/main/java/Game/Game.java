...
public abstract class Game {
    ...
    public void setup() {
        pathSoundOn = "/com/example/demo/image/soundOn.png";
        pathSoundOff = "/com/example/demo/image/soundOff.png";
        pathInstruction = "/com/example/demo/image/instruction.png";
        ...
        correct_sound = getClass().getResource("/com/example/demo/sound/correct.mp3").toExternalForm();
        wrong_sound = getClass().getResource("/com/example/demo/sound/wrong.mp3").toExternalForm();
        background_sound = getClass().getResource("/com/example/demo/sound/background.mp3").toExternalForm();
        option_sound = getClass().getResource("/com/example/demo/sound/option.mp3").toExternalForm();
        gameSelect_sound = getClass().getResource("/com/example/demo/sound/gameSelect.mp3").toExternalForm();
