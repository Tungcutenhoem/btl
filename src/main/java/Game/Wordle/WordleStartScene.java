...
public class WordleStartScene implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            StackPane tmpPane = (StackPane) FXMLLoader.load(getClass().getResource("/com/example/demo/fxml/Wordle/GameScene.fxml"));
            String css = this.getClass().getResource("/com/example/demo/css/Wordle/Game.css").toExternalForm();
