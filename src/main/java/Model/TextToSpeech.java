...
public class TextToSpeech {
    ...
    private static final String AUDIO_PATH = "C:\\tudienn\\src\\main\\resources\\com\\example\\demo\\voice\\English.wav";
    public static final double speed = 1;

    public static String languageCode = "";
    public static String languageName = "";

    public static void ttsTextArea(String word) throws Exception {
    ...
    public static void ttsTextFiled(String word , String languagecode ,String languagename) throws Exception {
        VoiceParameters paramsVoice = new VoiceParameters(word, AudioFormat.Format_44KHZ.AF_44khz_16bit_stereo);
        paramsVoice.setBase64(false);
        paramsVoice.setLanguage(languagecode);
        paramsVoice.setVoice(languagename);
